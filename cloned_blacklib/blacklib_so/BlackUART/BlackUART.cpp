...
#define DEVICE_BASE     "/dev/ttyS"
#define UART_BASE       "BB-UART"
...
namespace BlackLib
{
    ...
    {
        this->dtUartFilename            = UART_BASE + tostr(static_cast<int>(uart));
        this->uartPortPath              = DEVICE_BASE + tostr(static_cast<int>(uart));
