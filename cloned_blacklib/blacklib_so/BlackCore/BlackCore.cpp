...
#define CAPEMGR_PATH    "/sys/devices/platform"
...
namespace BlackLib
{
    ...
    BlackCore::BlackCore()
    {
        ...
        this->findOcpName();
        this->slotsFilePath = CAPEMGR_PATH + this->capeMgrName + "/slots";
    }
    ...
    {
        std::string searchResult = this->searchDirectory(CAPEMGR_PATH,"bone_capemgr");
    ...
    {
        std::string searchResult = this->searchDirectory(CAPEMGR_PATH,"ocp");
    ...
    std::string BlackCore::searchDirectoryOcp(BlackCore::ocpSearch searchThis)
    {
        ...
        std::string searchPath = CAPEMGR_PATH + this->getOcpName() + "/";
